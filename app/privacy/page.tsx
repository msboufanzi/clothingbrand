  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-light text-center mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            At Echaly, we respect your privacy and are committed to protecting your personal data. This privacy policy
          ...
          <p>
            Email: info@echaly.com
            <br />
            Postal address: 123 Fashion Avenue, Marrakech, Morocco
          </p>
        </div>
